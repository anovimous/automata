...
public class ProgramController {
	...
	@GetMapping("")
	public ResponseEntity<PageHolderResponse<Program>> getPrograms(@RequestParam(defaultValue = "") String query, @PageableDefault(size = 10, sort = "insertionDate", direction = Sort.Direction.ASC) Pageable pageable){
	...
	public ResponseEntity<Program> patchProgram(@PathVariable Long programId, @RequestBody PatchProgramRequest patchRequest){
